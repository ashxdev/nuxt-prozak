...
const isShowCookiePolice = useCookie("accepted_cookies", {
  expires: cookieExpiryDate
})

const handleSetCookie = () => (isShowCookiePolice.value = "yes")
</script>
<template>
  <div>
    <div
      class="alert alert-warning py-2 m-0 bg-primary border-0 rounded-0 alert-dismissible fade text-center overflow-hidden"
      :class="{
        show: !isShowCookiePolice,
        'd-none': isShowCookiePolice
      }"
      role="alert"
    >
      ...
      <div class="position-relative">
        <p class="text-white m-0">
          Я дозволяю PROZAK.INFO використовувати
          <NuxtLink class="badge badge-primary" href="/cookie-policy">
            cookie
          </NuxtLink>
          <button
      ...
      <button
        ...
        class="btn-close btn-close-white opacity-9 p-3"
        @click="handleSetCookie"
      ></button>
    </div>
  </div>
